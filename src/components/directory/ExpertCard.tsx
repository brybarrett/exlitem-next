...
export function ExpertCard({
  ...
  const handleClaimProfile = (expert: ExpertProfile) => {
                  ...
                  <Popover>
                    ...
                    <PopoverContent className='w-80'>
                      ...
                      <ul className='list-inside list-disc space-y-0.5'>
                        {expert.practiceAreas.slice(3).map((area, index) => (
      ...
      <CardContent className='flex h-full flex-col justify-between gap-2'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex flex-wrap justify-center gap-1'>
            {expert.practiceAreas?.slice(0, 2).map((area, index) => (
              <Badge
                key={index}
                variant='secondary'
            ...
            {expert.practiceAreas && expert.practiceAreas.length > 2 && (
              <Popover>
                ...
                <PopoverContent className='max-h-96 w-80 overflow-y-auto'>
                  <p className='text-md mb-2 font-medium'>Practice Areas</p>
                  <ul className='list-inside list-disc space-y-0.5'>
                    {expert.practiceAreas.slice(2).map((area, index) => (
                      <li key={index} className='text-xs'>
                        {area}
                      </li>
                    ))}
